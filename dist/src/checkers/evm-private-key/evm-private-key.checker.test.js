...
describe('EVM checker', () => {
    ...
    test('should filter one private key', async () => {
        ...
        const testDataOutput1 = 'test <Private key was removed by EVM private key checker> test';
        ...
        const testDataOutput2 = 'test <Private key was removed by EVM private key checker> test';
    ...
    test('should filter multiple private keys', async () => {
        ...
        const testDataOutput1 = 'test <Private key was removed by EVM private key checker> test <Private key was removed by EVM private key checker>';
        const result1 = await checker.processData(testDataInput1);
        expect(result1.processedValue).toEqual(testDataOutput1);
        expect(result1.triggered).toBe(true);
    });
